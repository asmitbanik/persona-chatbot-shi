...
function ChatInterface({ persona }) {
  ...
  return (
    <div className="flex flex-col h-full bg-transparent max-w-4xl mx-auto overflow-hidden mt-2">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="bg-gray-200 rounded-2xl rounded-bl-none px-4 py-3 flex items-center space-x-2">
      ...
      {/* 🧁 INPUT AREA */}
      <div className="p-4 bg-white/70 backdrop-blur-md border-t border-gray-300 rounded-b-2xl">
        ...
        <div className="mt-4 flex items-end space-x-2 bg-gray-100 p-2 rounded-full border border-gray-300 focus-within:border-gray-400 focus-within:ring-2 focus-within:ring-gray-300 transition-all">
          ...
          <button 
            ...
            className="p-2 mb-1 rounded-full bg-black text-white hover:bg-gray-900 disabled:bg-gray-300 transition-all flex-shrink-0 shadow-md"
          >
